...
namespace $rootnamespace$.Services
{
    public class MpaService : IMpaService
    {
        ...
        public async Task<NavigationResult> SendToMPA(Message message, CancellationToken cancellationToken, Dictionary<string, string> navigationParameters = null)
        {
            ...
            return await SendToMPA(new List<Message> { message }, cancellationToken, navigationParameters);
        }
        ...
        public async Task<NavigationResult> SendToMPA(string message, Node from, CancellationToken cancellationToken, Dictionary<string, string> navigationParameters = null)
        {
            ...
            return await SendToMPA(new List<Message> { new Message(EnvelopeId.NewId()) { Content = plainContent, From = from, To = from, Metadata = new Dictionary<string, string>() } }, cancellationToken, navigationParameters);
        }
